        ...
        <div className="grid lg:grid-cols-2 gap-10 xl:gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              <motion.a
                href="https://uzyntra.com" target="_blank" rel="noopener noreferrer"
                whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.96 }}
                className="flex items-center gap-2 px-5 py-2.5 bg-red-500 hover:bg-red-400 text-white font-semibold rounded-lg transition-colors text-sm shadow-lg shadow-red-500/20 hover:shadow-red-500/35"
              >
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.96 }}
                className="btn-ghost flex items-center gap-2 px-5 py-2.5 font-semibold rounded-lg text-sm"
              >
            ...
            {services.map((s, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="glass-card rounded-xl p-4 border border-red-400/15 hover:border-red-400/45 hover:shadow-lg hover:shadow-red-500/12 transition-all duration-300 group cursor-default"
                >
                  <motion.div
                    className="w-8 h-8 rounded-lg bg-red-400/10 flex items-center justify-center mb-3"
